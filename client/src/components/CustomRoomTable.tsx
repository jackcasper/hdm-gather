...
// Import Phaser game and Bootstrap scene
import phaserGame from '../PhaserGame'
import Bootstrap from '../scenes/Bootstrap'

// Create a styled component for message text
...
// Create a styled component for the custom room table container
...
// Create a styled component for the password dialog
...
// Define the CustomRoomTable component
export const CustomRoomTable = () => {
  ...
  // Use a custom hook to check if the user has joined the lobby and get available rooms
  const lobbyJoined = useAppSelector((state) => state.room.lobbyJoined)
  const availableRooms = useAppSelector((state) => state.room.availableRooms)

  // Handle the click event when joining a room
  ...
  // Handle the form submission for entering a password
  ...
  // Reset the password dialog state
