...
// Styled component for the backdrop of the chat
...
// Styled component for the wrapper of the chat
...
// Styled component for the wrapper of the FAB button
const FabWrapper = styled.div`
  margin-top: auto;
`

// Styled component for the header of the chat
...
// Styled component for the main chat box
...
// Styled component for the input form wrapper
...
// Styled component for the input text field
...
// Styled component for the emoji picker wrapper
...
// Date formatter for displaying message timestamps
const dateFormatter = new Intl.DateTimeFormat('en', {
  timeStyle: 'short',
  dateStyle: 'short',
})

// Functional component for rendering a single chat message
...
export default function Chat() {
  ...
  const handleKeyDown = (event: React.KeyboardEvent<HTMLInputElement>) => {
    if (event.key === 'Escape') {
      // Move focus back to the game and hide the chat
