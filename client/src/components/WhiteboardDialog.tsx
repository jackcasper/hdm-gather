...
const Wrapper = styled.div`
  ...
  // Define a styled component for the close button
  .close {
    position: absolute;
    top: 0px;
    right: 0px;
...
// Define a styled component for the whiteboard iframe wrapper
...
// Define the WhiteboardDialog component
export default function WhiteboardDialog() {
  // Get the whiteboard URL from the application state
  ...
  return (
    <Backdrop>
      <Wrapper>
        ...
        {whiteboardUrl && (
          // Display the whiteboard iframe if the whiteboard URL is available
          <WhiteboardWrapper>
