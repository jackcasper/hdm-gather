...
// Create a styled component for a wrapper
...
// Create a styled component for a group of buttons
...
// Create a styled component for displaying the room name
...
// Create a styled component for displaying the room description
...
// Create a styled component for a customized Fab button
...
// Define the HelperButtonGroup component
export default function HelperButtonGroup() {
  // Define state variables using the useState hook
  const [showControlGuide, setShowControlGuide] = useState(false)
  const [showRoomInfo, setShowRoomInfo] = useState(false)

  // Use custom hooks to get and update state variables
